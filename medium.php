...
<center><section>
        <img src="http://i.imgur.com/WCYX2ct.png" alt="Medium Subscription">
        <h1>Medium Subscription Box</h1>
        <h2>The Small Box comes with our five most popular flavors:</h2>
        <h2><li>French Caramel Bean</li></h2>
        <h2><li>Vanilla Bean</li></h2>
        <h2><li>Pumpkin Spice</li></h2>
        <h2><li>Mocha</li></h2>
        <h2><li>Mochiatto</li></h2>
        <h3>The Medium box comes with </h3>
    </section></center>
